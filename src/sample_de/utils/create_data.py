...
if __name__ == "__main__":
    ...
    sampleDsCreator.create_demo_sales_dataset(
        os.getenv("DATASET"), num_rows=100
    )  # Call the function to create the test dataset with 100 rows
    sampleDsCreator.create_demo_stock_dataset(
        os.getenv("STOCK_DATASET"), num_rows=100
    )  # Call the function to create the test stock dataset with 100 rows
